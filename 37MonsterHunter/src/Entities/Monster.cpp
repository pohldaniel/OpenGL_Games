...
void Monster::initUI() {
	...
	Label* label = surface->addChild<Label>(Globals::fontManager.get("dialog"));
	...
	/*Icon* icon = iconAnimated->addChild<Icon>(TileSetManager::Get().getTileSet("monster").getTextureRects()[257]);
