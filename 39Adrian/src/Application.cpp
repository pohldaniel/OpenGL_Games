...
void Application::loadAssets() {
	...
	Globals::shaderManager.loadShader("toon", "res/shader/quad.vert", "res/shader/toon.frag");
	Globals::shaderManager.loadShader("bloom", "res/shader/quad.vert", "res/shader/bloom.frag");
