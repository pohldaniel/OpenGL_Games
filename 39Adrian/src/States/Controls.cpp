...
Controls::Controls(StateMachine& machine) : State(machine, States::CONTROLLS) {
	...
	m_button.setCharset(Globals::fontManager.get("upheaval_30"));
	...
	m_textFields.at("w").setCharset(Globals::fontManager.get("upheaval_30"));
	...
	m_textFields.at("a").setCharset(Globals::fontManager.get("upheaval_30"));
	...
	m_textFields.at("s").setCharset(Globals::fontManager.get("upheaval_30"));
	...
	m_textFields.at("d").setCharset(Globals::fontManager.get("upheaval_30"));
	...
	m_textFields.at("space").setCharset(Globals::fontManager.get("upheaval_30"));
	...
	m_textFields.at("mouse").setCharset(Globals::fontManager.get("upheaval_30"));
	...
	m_textFields.at("rm").setCharset(Globals::fontManager.get("upheaval_30"));
	...
	m_textFields.at("f1").setCharset(Globals::fontManager.get("upheaval_30"));
	...
	m_textFields.at("wheel").setCharset(Globals::fontManager.get("upheaval_30"));
	...
	m_textFields.at("alt").setCharset(Globals::fontManager.get("upheaval_30"));
	...
	m_textFields.at("enter").setCharset(Globals::fontManager.get("upheaval_30"));
...
void Controls::render() {
	...
	Globals::fontManager.get("upheaval_30").bind(0);
	Fontrenderer::Get().addText(Globals::fontManager.get("upheaval_30"), static_cast<float>(Application::Width / 2 - 665), static_cast<float>(Application::Height - 300), "Move", Vector4f(1.0f, 1.0f, 1.0f, 1.0f));
	Fontrenderer::Get().addText(Globals::fontManager.get("upheaval_30"), static_cast<float>(Application::Width / 2 +  50), static_cast<float>(Application::Height - 300), "Break", Vector4f(1.0f, 1.0f, 1.0f, 1.0f));
	Fontrenderer::Get().addText(Globals::fontManager.get("upheaval_30"), static_cast<float>(Application::Width / 2 - 665), static_cast<float>(Application::Height - 500), "Jump to last activated respawnpoint", Vector4f(1.0f, 1.0f, 1.0f, 1.0f));
	Fontrenderer::Get().addText(Globals::fontManager.get("upheaval_30"), static_cast<float>(Application::Width / 2 + 420), static_cast<float>(Application::Height - 500), "Zoom", Vector4f(1.0f, 1.0f, 1.0f, 1.0f));
	Fontrenderer::Get().addText(Globals::fontManager.get("upheaval_30"), static_cast<float>(Application::Width / 2 - 665), static_cast<float>(Application::Height - 700), "Look around", Vector4f(1.0f, 1.0f, 1.0f, 1.0f));
	Fontrenderer::Get().addText(Globals::fontManager.get("upheaval_30"), static_cast<float>(Application::Width / 2 - 220), static_cast<float>(Application::Height - 700), "Toggle Fullscreen", Vector4f(1.0f, 1.0f, 1.0f, 1.0f));
