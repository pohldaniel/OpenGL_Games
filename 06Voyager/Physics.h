...
public:
	...
	static Matrix4f MatrixFrom(const Matrix4f& mtx, const btTransform& trans, const btVector3& scale = btVector3(1.0f, 1.0f, 1.0f));
	static Matrix4f MatrixTransposeFrom(const btTransform& trans, const btVector3& scale = btVector3(1.0f, 1.0f, 1.0f));
	static Matrix4f MatrixTransposeFrom(const Matrix4f& mtx, const btTransform& trans, const btVector3& scale = btVector3(1.0f, 1.0f, 1.0f));
