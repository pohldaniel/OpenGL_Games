...
float shadowCoef() {
	...
	// Gaussian 3x3 filter
	float ret = texture(stex, shadow_coord) * 0.25;
	ret += textureOffset(stex, shadow_coord, ivec2( -1, -1)) * 0.0625;
	ret += textureOffset(stex, shadow_coord, ivec2( -1, 0)) * 0.125;
	ret += textureOffset(stex, shadow_coord, ivec2( -1, 1)) * 0.0625;
	ret += textureOffset(stex, shadow_coord, ivec2( 0, -1)) * 0.125;
	ret += textureOffset(stex, shadow_coord, ivec2( 0, 1)) * 0.125;
	ret += textureOffset(stex, shadow_coord, ivec2( 1, -1)) * 0.0625;
	ret += textureOffset(stex, shadow_coord, ivec2( 1, 0)) * 0.125;
	ret += textureOffset(stex, shadow_coord, ivec2( 1, 1)) * 0.0625;
