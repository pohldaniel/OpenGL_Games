...
void Application::Resize(int deltaW, int deltaH) {
	...
	Globals::projection = Matrix4f::Perspective(Globals::projection, 45.0f, static_cast<float>(Width) / static_cast<float>(Height), 1.0f, 1000.0f);
	Globals::invProjection = Matrix4f::InvPerspective(Globals::invProjection, 45.0f, static_cast<float>(Width) / static_cast<float>(Height), 1.0f, 1000.0f);
	Globals::orthographic = Matrix4f::Orthographic(Globals::orthographic, 0.0f, static_cast<float>(Width), 0.0f, static_cast<float>(Height), -1.0f, 1.0f);
...
void Application::loadAssets() {
	Globals::shaderManager.loadShader("instance", "res/instance.vert", "res/instance.frag");
	Globals::shaderManager.loadShader("mesh", "res/mesh.vert", "res/mesh.frag");
}