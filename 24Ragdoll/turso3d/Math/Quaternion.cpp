...
const QuaternionTu QuaternionTu::IDENTITY(1.0f, 0.0f, 0.0f, 0.0f);

void QuaternionTu::FromAngleAxis(float angle, const Vector3& axis)
{
...
void QuaternionTu::FromEulerAngles(float x_, float y_, float z_)
{
...
void QuaternionTu::FromRotationTo(const Vector3& start, const Vector3& end)
{
...
void QuaternionTu::FromAxes(const Vector3& xAxis, const Vector3& yAxis, const Vector3& zAxis)
{
    Matrix3 matrix(
...
void QuaternionTu::FromRotationMatrix(const Matrix3& matrix)
{
...
bool QuaternionTu::FromLookRotation(const Vector3& direction, const Vector3& upDirection)
{
	QuaternionTu ret;
...
bool QuaternionTu::FromString(const char* string)
{
...
Vector3 QuaternionTu::EulerAngles() const
{
...
float QuaternionTu::YawAngle() const
{
    return EulerAngles().y;
}

float QuaternionTu::PitchAngle() const
{
    return EulerAngles().x;
}

float QuaternionTu::RollAngle() const
{
    return EulerAngles().z;
}

QuaternionTu QuaternionTu::Slerp(QuaternionTu rhs, float t) const
{
...
QuaternionTu QuaternionTu::Nlerp(QuaternionTu rhs, float t, bool shortestPath) const
{
	QuaternionTu result;
...
std::string QuaternionTu::ToString() const
{
