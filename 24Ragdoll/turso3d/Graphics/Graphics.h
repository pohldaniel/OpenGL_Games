...
public:
    ...
    void SetFrameBuffer(FrameBufferTu* buffer);
    ...
    void Blit(FrameBufferTu* dest, const IntRect& destRect, FrameBufferTu* src, const IntRect& srcRect, bool blitColor, bool blitDepth, TextureFilterMode filter);
