...
void Attribute::FromJSON(AttributeType type, void* dest, const JSONValue& source)
{
    ...
    case ATTR_QUATERNION:
        reinterpret_cast<QuaternionTu*>(dest)->FromString(source.GetString());
        break;
...
void Attribute::ToJSON(AttributeType type, JSONValue& dest, const void* source)
{
    ...
    case ATTR_QUATERNION:
        dest = reinterpret_cast<const QuaternionTu*>(source)->ToString();
        break;
...
template<> AttributeType AttributeImpl<QuaternionTu>::Type() const
{
