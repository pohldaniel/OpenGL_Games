...
private:
    ...
    void CollectDrawablesMasked(std::vector<Drawable*>& result, Octant* octant, const FrustumTu& frustum, unsigned short drawableFlags, unsigned layerMask, unsigned char planeMask = 0x3f) const
    {
        if (planeMask)
        {
