Level = {
    ...
    assets = {
        [0] =
        { type = "tileset",		id = "tilemap-texture",			file = "./assets/tilemaps/desert.png" },
        { type = "spritesheet", id = "tank-texture",			file = "./assets/images/tank-panther-spritesheet.png" },
		{ type = "spritesheet", id = "su27-texture",			file = "./assets/images/su27-spritesheet.png" },
		{ type = "spritesheet", id = "bomber-texture",			file = "./assets/images/bomber-spritesheet.png" },
		{ type = "spritesheet",	id = "f22-texture",				file = "./assets/images/f22-spritesheet.png" },
        { type = "spritesheet",	id = "fw190-texture",			file = "./assets/images/fw190-spritesheet.png" },
        { type = "spritesheet",	id = "upf7-texture",			file = "./assets/images/upf7-spritesheet.png" },
        { type = "spritesheet",	id = "bf109-texture",			file = "./assets/images/bf109-spritesheet.png" },
        { type = "spritesheet",	id = "sam-tank-left-texture",	file = "./assets/images/sam-tank-left-spritesheet.png" },
        { type = "spritesheet",	id = "sam-tank-right-texture",	file = "./assets/images/sam-tank-right-spritesheet.png" },
		{ type = "spritesheet",	id = "radar-texture",			file = "./assets/images/radar-spritesheet.png" },
		{ type = "spritesheet", id = "sam-tank-left-texture",	file = "./assets/images/sam-tank-left-spritesheet.png" },
        { type = "spritesheet", id = "sam-tank-right-texture",	file = "./assets/images/sam-tank-right-spritesheet.png" },
		{ type = "splitted", 	id = "tank-tiger",      		file = {
																		"./assets/images/tank-tiger-up.png", 
																		"./assets/images/tank-tiger-right.png", 
																		"./assets/images/tank-tiger-down.png", 
																		"./assets/images/tank-tiger-left.png", 
																		"./assets/images/tank-tiger-killed.png" }},
		{ type = "splitted", 	id = "tank-panther",        	file = {
																		"./assets/images/tank-panther-up.png", 
																		"./assets/images/tank-panther-right.png", 
																		"./assets/images/tank-panther-down.png", 
																		"./assets/images/tank-panther-left.png", 
																		"./assets/images/tank-panther-killed.png" }},	
		{ type = "splitted", 	id = "truck-ford",      		file = {
																		"./assets/images/truck-ford-up.png", 
																		"./assets/images/truck-ford-right.png", 
																		"./assets/images/truck-ford-down.png", 
																		"./assets/images/truck-ford-left.png", 
																		"./assets/images/truck-ford-killed.png" }},	
		{ type = "splitted", 	id = "army-walk",       		file = {
		...
		{ type = "splitted", 	id = "army-gun",        		file = {
		...
		{ type = "texture",		id = "sam-truck",				file = "./assets/images/sam-truck-right.png" },																
		...
		{ type = "texture",		id = "empty-texture",			file = "./assets/images/empty.png" },
