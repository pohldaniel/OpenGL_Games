...
btCollisionShape * Physics::CreateStaticCollisionShape(AssimpMesh* mesh, const btVector3 & scale) {
...
std::vector<btCollisionShape*> Physics::CreateStaticCollisionShapes(AssimpModel* model, const btVector3 & scale) {
...
std::vector<btCollisionShape*> Physics::CreateStaticCollisionShapes(AssimpModel * model, float scale) {
