    ...
    public:
        ...
        void OnProjectileHitsPlayer(Entity projectile, Entity player) {
            ...
            if (!projectileComponent.isFriendly && player.HasComponent<HealthComponent>()) {
				...
				std::cout << "Projectile id: " + std::to_string(projectile.GetId()) + " collided with player id: " + std::to_string(player.GetId()) << std::endl;
        ...
        void OnProjectileHitsEnemy(Entity projectile, Entity enemy) {
            ...
            if (projectileComponent.isFriendly && enemy.HasComponent<HealthComponent>()) {
				...
				std::cout << "Projectile id: " + std::to_string(projectile.GetId()) + " collided with enemy id: " + std::to_string(enemy.GetId()) << std::endl;
