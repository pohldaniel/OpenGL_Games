...
SSSApproximation::SSSApproximation(StateMachine& machine) : State(machine, States::DEFAULT) {
	...
	m_camera.lookAt(Vector3f(0.0f, 15.0f, -20.0f), Vector3f(0.0f, 15.0f, -20.0f) + Vector3f(0.0f, 0.0f, 1.0f), Vector3f(0.0f, 1.0f, 0.0f));
	...
	m_lightViewProjection = m_camera.getPerspectiveMatrix() * m_lightView * Matrix4f::IDENTITY;
