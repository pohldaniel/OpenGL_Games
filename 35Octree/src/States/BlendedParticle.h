...
class BlendedParticle : public State, public MouseEventListener, public KeyboardEventListener {

	static const int MAX_PARTICLES = 2500;
...
public:
	...
	BlendedParticle(StateMachine& machine);
	~BlendedParticle();
...
private:
	...
	LinearSpline m_alphaSplineF, m_sizeSplineF, m_alphaSplineS, m_sizeSplineS, m_alphaSplineX, m_sizeSplineX;
	ColorSpline m_colorSplineF, m_colorSplineS, m_colorSplineX;
