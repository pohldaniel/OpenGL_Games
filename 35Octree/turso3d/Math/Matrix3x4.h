...
public:
    ...
    Matrix3x4(const Vector3& translation, const QuaternionTu& rotation, float scale)
    {
        SetTransform(translation, rotation, scale);
    }

    /// Construct from translation, rotation and nonuniform scale.
    Matrix3x4(const Vector3& translation, const QuaternionTu& rotation, const Vector3& scale)
    {
        SetTransform(translation, rotation, scale);
    }
    ...
    void SetTransform(const Vector3& translation, const QuaternionTu& rotation, float scale)
    {
    ...
    void SetTransform(const Vector3& translation, const QuaternionTu& rotation, const Vector3& scale)
    {
	...
	QuaternionTu Rotation() const { return QuaternionTu(RotationMatrix()); }
    ...
    void Decompose(Vector3& translation, QuaternionTu& rotation, Vector3& scale) const
    {
        translation.x = m03;
        translation.y = m13;
        translation.z = m23;
        ...
        rotation = QuaternionTu(ToMatrix3().Scaled(invScale));
    }
