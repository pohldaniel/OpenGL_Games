...
struct CollectBatchesTask : public MemberFunctionTaskTu<Renderer>
{
	/// Construct.
...
struct CollectShadowCastersTask : public MemberFunctionTaskTu<Renderer>
{
	/// Construct.
...
struct CollectShadowBatchesTask : public MemberFunctionTaskTu<Renderer>
{
	/// Construct.
...
struct CullLightsTask : public MemberFunctionTaskTu<Renderer>
{
	/// Construct.
