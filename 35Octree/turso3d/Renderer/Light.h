...
struct ShadowView
{
    ...
    IntRect viewport;
    /// Shadow camera.
    SharedPtr<CameraTu> shadowCamera;
    /// Shadow camera frustum.
    FrustumTu shadowFrustum;
...
class LightTu : public OctreeNodeTu
{
    OBJECT(LightTu);
...
public:
    ...
    /// Return spotlight world space frustum.
    FrustumTu WorldFrustum() const { return static_cast<LightDrawable*>(drawable)->WorldFrustum(); }
    /// Return point light world space sphere.
