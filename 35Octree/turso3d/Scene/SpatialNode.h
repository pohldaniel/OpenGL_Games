...
class SpatialNode : public NodeTu
{
    OBJECT(SpatialNode);
...
public:
    ...
    void SetRotation(const QuaternionTu& newRotation);
    ...
    void SetTransform(const Vector3& newPosition, const QuaternionTu& newRotation);
    /// Set transform in parent space.
    void SetTransform(const Vector3& newPosition, const QuaternionTu& newRotation, const Vector3& newScale);
    /// Set transform in parent space.
    void SetTransform(const Vector3& newPosition, const QuaternionTu& newRotation, float newScale);
    /// Set position in world space.
    void SetWorldPosition(const Vector3& newPosition);
    /// Set rotation in world space
    void SetWorldRotation(const QuaternionTu& newRotation);
    ...
    void SetWorldTransform(const Vector3& newPosition, const QuaternionTu& newRotation);
    /// Set transform in world space.
    void SetWorldTransform(const Vector3& newPosition, const QuaternionTu& newRotation, const Vector3& newScale);
    /// Set transform in world space.
    void SetWorldTransform(const Vector3& newPosition, const QuaternionTu& newRotation, float newScale);
    /// Move the scene node in the chosen transform space.
    void Translate(const Vector3& delta, TransformSpace space = TS_LOCAL);
    /// Rotate the scene node in the chosen transform space.
    void Rotate(const QuaternionTu& delta, TransformSpace space = TS_LOCAL);
    /// Rotate around a point in the chosen transform space.
    void RotateAround(const Vector3& point, const QuaternionTu& delta, TransformSpace space = TS_LOCAL);
    ...
    const QuaternionTu& Rotation() const { return rotation; }
...
protected:
    ...
    void OnParentSet(NodeTu* newParent, NodeTu* oldParent) override;
