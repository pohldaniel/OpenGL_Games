...
public:
	...
	_Shader(const char* vertex_shader_file, const char* fragment_shader_file) {
        shader = 0;
...
class WaterFlowPassShader : public _Shader {
public:

    bool dirty = false;

    WaterFlowPassShader() : _Shader("res/shaders/common.vert", "res/shaders/waterFlow.frag") {};
...
class WaterShader : public _Shader {
public:
    WaterShader() : _Shader("res/shaders/common.vert", "res/shaders/water.frag") {};
...
class NewLightingShader : public _Shader {
public:
    float lastLx = 0.0;
    float lastLy = 0.0;
    ...
    NewLightingShader() : _Shader("res/shaders/common.vert", "res/shaders/newLighting.frag") {};
...
class FireShader : public _Shader {
public:
    FireShader() : _Shader("res/shaders/common.vert", "res/shaders/fire.frag") {};
...
class Fire2Shader : public _Shader {
public:
    Fire2Shader() : _Shader("res/shaders/common.vert", "res/shaders/fire2.frag") {};
