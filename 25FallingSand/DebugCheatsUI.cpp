...
void DebugCheatsUI::Setup() {
	...
	/*images = {};
	SDL_Surface* sfc = Textures::loadTexture("res/objects/testPickaxe.png");
	images.push_back(GPU_CopyImageFromSurface(sfc));
	GPU_SetImageFilter(images[0], GPU_FILTER_NEAREST);
	SDL_FreeSurface(sfc);
	sfc = Textures::loadTexture("res/objects/testHammer.png");
	images.push_back(GPU_CopyImageFromSurface(sfc));
	GPU_SetImageFilter(images[1], GPU_FILTER_NEAREST);
	SDL_FreeSurface(sfc);
	sfc = Textures::loadTexture("res/objects/testVacuum.png");
	images.push_back(GPU_CopyImageFromSurface(sfc));
	GPU_SetImageFilter(images[2], GPU_FILTER_NEAREST);
	SDL_FreeSurface(sfc);
	sfc = Textures::loadTexture("res/objects/testBucket.png");
	images.push_back(GPU_CopyImageFromSurface(sfc));
