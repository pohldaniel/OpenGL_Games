...
CharacterSkinned::CharacterSkinned() : m_onGround(true), m_okToJump(true), m_jumpStarted(false), m_isJumping(false), m_inAirTimer(0.0f), weaponActionState_(Weapon_Invalid),
