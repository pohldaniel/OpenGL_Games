...
ObjModelNew::ObjModelNew(const std::string& filepath) {
	LoadObj(filepath);
}

const std::vector<float>& ObjModelNew::GetVertices() const {
	return vertices;
}

const std::vector<unsigned int>& ObjModelNew::GetIndices() const {
	return indices;
}

void ObjModelNew::LoadObj(const std::string& filepath) {
