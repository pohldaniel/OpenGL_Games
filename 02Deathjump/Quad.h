...
public:
	...
	Quad(bool flippable = false, float shiftX = 0.0f, float shiftY = 0.0f, float sizeX = 1.0f, float sizeY = 1.0f, float sizeTexX = 1.0f, float sizeTexY = 1.0f, short x = 0, short y = 0);
	~Quad();
