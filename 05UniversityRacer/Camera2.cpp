...
Camera2::Camera2(void): currentSettleTime(0.f) {
	Reset();
}
 ...
 */
void Camera2::Follow(glm::mat4 & targetMat, glm::vec3 targetVelocity, const float gameTime)
{
  ...
  //static float currentSettleTime = 0.f;
    ...
    lastBaseLookFromPos -= targetVelocity * (gameTime);
