...
public:
	...
	bool loadModel(const char* a_filename, Vector3f& rotate, float degree, Vector3f& translate, float scale, bool asStacked = false, bool withoutNormals = false, bool generateSmoothNormals = false, bool generateFlatNormals = false, bool generateSmoothTangents = false);
