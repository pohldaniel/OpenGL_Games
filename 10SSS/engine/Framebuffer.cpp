...
void Framebuffer::attachTexture(AttachmentTex::AttachmentTex attachments) {
	...
	if (attachment == AttachmentTex::SRGBA || attachments == AttachmentTex::RGBA || attachments == AttachmentTex::RGBA32F || attachments == AttachmentTex::RGBA16F || attachments == AttachmentTex::RGB32F || attachments == AttachmentTex::RGB16F || attachments == AttachmentTex::RED || attachments == AttachmentTex::RED32F || attachments == AttachmentTex::RG16F) {
...
void Framebuffer::attachTexture(Attachment::Attachment attachments, unsigned int& _texture) {
	...
	if (attachments == AttachmentTex::SRGBA || attachments == AttachmentTex::RGBA || attachments == AttachmentTex::RGBA32F || attachments == AttachmentTex::RGBA16F || attachments == AttachmentTex::RGB32F || attachments == AttachmentTex::RGB16F || attachments == AttachmentTex::RED) {
