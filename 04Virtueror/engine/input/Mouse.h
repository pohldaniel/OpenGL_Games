...
public:
	...
	float xPosRelative() const{
		return m_attached ? m_xPosRelative : m_xPosRelativeDetached;
	}

	float yPosRelative() const{
		return m_attached ? m_yPosRelative : m_yPosRelativeDetached;
	}
...
private:
	...
	int m_xPosRelativeDetached, m_yPosRelativeDetached;
