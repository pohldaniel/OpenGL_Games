...
private:
	...
	bool m_jumpPressed, m_wantJump, m_blockJump, m_upPressed, m_dashPressed, m_wantAdditionalJump, m_infinitWall;
	...
	bool m_wantReset;
	Timer m_coyoteWallJumpTimer, m_coyoteJumpTimer, m_jumpBuffer, m_dashTimer, m_waitTimer;
	...
	unsigned short m_jumpCount, m_maxJumps, m_currentMaxJumps;
};