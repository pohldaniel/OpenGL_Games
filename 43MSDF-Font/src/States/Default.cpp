...
void Default::render() {
	...
	Fontrenderer::Get().addText(Globals::fontManager.get("upheaval_150"), static_cast<float>(Application::Width) * 0.5f, static_cast<float>(Application::Height) * 0.5f , "WhQH", Vector4f(1.0f, 1.0f, 1.0f, 1.0f), m_fontSize);
	...
	Fontrenderer::Get().addText(Globals::fontManager.get("upheaval_150_msdf"), static_cast<float>(Application::Width) * 0.5f, static_cast<float>(Application::Height) * 0.5f - (Globals::fontManager.get("upheaval_150_msdf").lineHeight + 10.0f) * m_fontSize, "WhQH", Vector4f(1.0f, 1.0f, 1.0f, 1.0f), m_fontSize);
	Fontrenderer::Get().drawBuffer();
	glDisable(GL_ALPHA_TEST);

    Fontrenderer::Get().setShader(Globals::shaderManager.getAssetPointer("font_msdf"));
	Globals::fontManager.get("upheaval_150_msdf_bm").bind();
	Fontrenderer::Get().addText(Globals::fontManager.get("upheaval_150_msdf_bm"), static_cast<float>(Application::Width) * 0.5f, static_cast<float>(Application::Height) * 0.5f - (Globals::fontManager.get("upheaval_150_msdf").lineHeight + 20.0f + Globals::fontManager.get("upheaval_150_msdf_bm").lineHeight) * m_fontSize, "WhQH", Vector4f(1.0f, 1.0f, 1.0f, 1.0f), m_fontSize);
	Fontrenderer::Get().drawBuffer();
