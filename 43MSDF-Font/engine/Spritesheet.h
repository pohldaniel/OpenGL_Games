...
public:
	...
	void loadFromFile(std::string fileName, const bool flipVertical = false, unsigned int internalFormat = 0u, unsigned int format = 0u, unsigned int SOIL_FLAG = 0u);
	...
	static void LoadFromFile(unsigned int& textureRef, std::string fileName, const bool flipVertical = false, unsigned int internalFormat = 0u, unsigned int format = 0u, unsigned int SOIL_FLAG = 0u);
