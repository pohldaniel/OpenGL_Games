...
////////////////////////////TileSet//////////////////////////////////////////
void TileSet::loadTileSet(std::string name, unsigned int _width, unsigned int _height, bool resetLine) {
	...
	while (!readTileSet.eof()) {
		...
		TextureAtlasCreator::Get().addTexture(bytes, imageWidth, imageHeight, textureRects, true, 0u, 0u, m_textureRects);
		if (resetLine)
