...
public:
	...
	Tag GetTag() const override { return Tag::BLENDSTATE; }
public:
...
private:
	...
	std::vector<std::shared_ptr<Animation>>		animations;				// which animations this state plays
	...
	std::vector<Vector2f>							blendNodes;
