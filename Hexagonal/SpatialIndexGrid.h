...
//	eSpatialIndexGrid &		operator=(eSpatialIndexGrid other);
	...
	bool					IsValid(const Vector2f & point) const;
	void					Validate(Vector2f & point) const;
	void					Validate(int & row, int & column) const;

//	void					Index(type * const indexPtr, int & row, int & column) const;
	type &					IndexValidated(const Vector2f & point);
	const type &			IndexValidated(const Vector2f & point) const;
	void					Index(const Vector2f & point, int & row, int & column) const;
	type &					Index(const Vector2f & point);
	const type &			Index(const Vector2f & point) const;
	...
	int						MinZPositionFromLayer(const unsigned int layer) const;
	int						MaxZPositionFromLayer(const unsigned int layer) const;
	int						CellWidth() const;
...
//**************
template< class type, int rows, int columns>
inline bool eSpatialIndexGrid<type, rows, columns>::IsValid(const Vector2f & point) const {
	return (point[0] >= 0 && point[0] <= Width() - 1 && point[1] >= 0 && point[1] <= Height() - 1);
}
...
//******************
template< class type, int rows, int columns>
inline void eSpatialIndexGrid<type, rows, columns>::Validate(Vector2f & point) const {
	int width;
	int height;
...
//******************
template< class type, int rows, int columns>
inline const type & eSpatialIndexGrid<type, rows, columns>::IndexValidated(const Vector2f & point) const {
	int row;
	int column;
...
//******************
template< class type, int rows, int columns>
inline type & eSpatialIndexGrid<type, rows, columns>::IndexValidated(const Vector2f & point) {
	int row;
	int column;
	Index(point, row, column);
	Validate(row, column);
...
//******************
template< class type, int rows, int columns>
inline type & eSpatialIndexGrid<type, rows, columns>::Index(const Vector2f & point) {
	int row;
	int column;
	Index(point, row, column);
...
//******************
template< class type, int rows, int columns>
inline const type & eSpatialIndexGrid<type, rows, columns>::Index(const Vector2f & point) const {
	int row;
	int column;
	Index(point, row, column);
	return cells[row][column];
...
//******************
template< class type, int rows, int columns>
inline int eSpatialIndexGrid<type, rows, columns>::MinZPositionFromLayer(const unsigned int layer) const {
	int minLayerZ = 0;
...
//******************
template< class type, int rows, int columns>
inline int eSpatialIndexGrid<type, rows, columns>::MaxZPositionFromLayer(const unsigned int layer) const {
