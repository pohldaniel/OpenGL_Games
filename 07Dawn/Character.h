...
public:
	...
	virtual unsigned short getModifiedHealthRegen() const;
	virtual unsigned short getModifiedManaRegen() const;
	virtual unsigned short getModifiedFatigueRegen() const;
	virtual unsigned short getModifiedMaxHealth() const;
	virtual unsigned short getModifiedMaxMana() const;
	virtual unsigned short getModifiedMaxFatigue() const;
	virtual unsigned short getModifiedStrength() const;
	virtual unsigned short getModifiedDexterity() const;
	virtual unsigned short getModifiedVitality() const;
	virtual unsigned short getModifiedIntellect() const;
	virtual unsigned short getModifiedWisdom() const;
	virtual unsigned short getModifiedMaxDamage() const;
	virtual unsigned short getModifiedMinDamage() const;
	virtual unsigned short getModifiedSpellEffectElementModifierPoints(Enums::ElementType elementType) const;
	virtual unsigned short getModifiedResistElementModifierPoints(Enums::ElementType elementType) const;
	virtual unsigned short getModifiedSpellCriticalModifierPoints() const;
	virtual unsigned short getModifiedDamageModifierPoints() const;
	virtual unsigned short getModifiedHitModifierPoints() const;
	virtual unsigned short getModifiedMeleeCriticalModifierPoints() const;
	virtual unsigned short getModifiedEvadeModifierPoints() const;
	virtual unsigned short getModifiedParryModifierPoints() const;
	virtual unsigned short getModifiedBlockModifierPoints() const;
	virtual unsigned short getModifiedArmor() const;
	...
	virtual unsigned short getSpellEffectElementModifierPoints(Enums::ElementType elementType) const;
