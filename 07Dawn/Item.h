...
namespace ArmorType {
	...
	inline ArmorType getHighestArmorTypeByClass(Enums::CharacterClass characterClass) {
...
public:
	TriggerSpellOnItem(SpellActionBase* spellToTrigger, float chanceToTrigger, TriggerType::TriggerType triggerType, bool castOnSelf);
...
public:
	...
	void addTriggerSpellOnSelf(SpellActionBase* spellToTrigger, float chanceToTrigger, TriggerType::TriggerType triggerType);
	void addTriggerSpellOnTarget(SpellActionBase* spellToTrigger, float chanceToTrigger, TriggerType::TriggerType triggerType);
