...
curSpell:setSpellSymbol( "res/spells/magicmissile/symbol.tga" );
...
curSpell:setSpellSymbol( "res/spells/venomspit/symbol.tga" );
...
curSpell:setSpellSymbol( "res/spells/electrocute/symbol.tga" );
...
curSpell:setSpellSymbol( "res/spells/inferno/symbol.tga" );
curSpell:setNumAnimations( 1 );
...
curSpell:setSpellSymbol( "res/spells/lightning/symbol.tga" );
curSpell:setNumAnimations( 5 );
...
curSpell:setSpellSymbol( "res/spells/healing/symbol.tga" );
...
curSpell:setSpellSymbol( "res/spells/healother/symbol.tga" );
...
curSpell:setSpellCost( 0 );
curSpell:setSpellSymbol( "res/spells/shieldbash/symbol.tga" );
curSpell:setEffectType( Enums.SelfAffectingSpell );
...
curSpell:setSpellCost( 75 );
curSpell:setSpellSymbol( "res/spells/leatherskin/symbol.tga" );
curSpell:setEffectType( Enums.SelfAffectingSpell );
...
curSpell:setSpellCost( 0 );
curSpell:setSpellSymbol( "res/spells/layingofhands/symbol.tga" );
curSpell:setEffectType( Enums.SelfAffectingSpell );
...
curSpell:setSpellSymbol( "res/spells/callingofthegrave/symbol.tga" );
curSpell:setEffectType( Enums.SelfAffectingSpell );
curSpell:setRequiredClass( Enums.Liche );
...
curSpell:setCastTime( 1000 );
curSpell:setSpellCost( 0 );
curSpell:setSpellSymbol( "res/spells/mightofthetitan/symbol.tga" );
curSpell:setEffectType( Enums.SelfAffectingSpell );
curSpell:setRequiredClass( Enums.Warrior );
...
curSpell:setCastTime( 0 );
curSpell:setSpellSymbol( "res/spells/vortex/symbol.tga" );
curSpell:setEffectType( Enums.SelfAffectingSpell );
curSpell:setRequiredClass( Enums.ANYCLASS );
...
curSpell:setSpellCost( 75 );
curSpell:setCastTime( 2000 );
curSpell:setSpellSymbol( "res/spells/earthenseeds/symbol.tga" );
curSpell:setEffectType( Enums.SelfAffectingSpell );
curSpell:setRequiredClass( Enums.Liche );
...
curSpell:setSpellSymbol( "res/spells/melee/symbol.tga" );
curSpell:setSpellCost( 0 );
curSpell:setRequiredClass( Enums.ANYCLASS );
...
curSpell:setSpellSymbol( "res/spells/phantomstrike/symbol.tga" );
curSpell:setSpellCost( 50 );
curSpell:setRequiredClass( Enums.Warrior );
...
curSpell:setSpellSymbol( "res/spells/venomweave/symbol.tga" );
...
curSpell:setCastTime( 2000 );
curSpell:setSpellCost( 0 );
curSpell:setSpellSymbol( "res/spells/shoot/symbol.tga" );
curSpell:setNumAnimations( 1 );
...
curSpell:setSpellSymbol( "res/spells/terrify/symbol.tga" );
...
curSpell:setSpellSymbol( "res/spells/food/symbol.tga" );
curSpell:setEffectType( Enums.SelfAffectingSpell );
...
curSpell:setDuration( 12 );
curSpell:setSpellSymbol( "res/spells/frozenshot/symbol.tga" );
...
curSpell:setDuration( 5 );
curSpell:setSpellSymbol( "res/spells/pindown/symbol.tga" );
...
curSpell:setSpellSymbol( "res/spells/flamingarrow/symbol.tga" );
curSpell:setNumAnimations( 1 );
curSpell:setAnimationTexture( 0, "res/spells/shoot/0.tga" );
curSpell:setMoveSpeed( 1000 );
curSpell:setRequiredClass( Enums.Ranger );
...
curSpell:setSpellSymbol( "res/spells/landyrsforce/symbol.tga" );
curSpell:setNumAnimations( 1 );
...
curSpell:setCastTime( 2000 );
curSpell:setSpellSymbol( "res/spells/voiceoftheforest/symbol.tga" );
curSpell:setEffectType( Enums.SelfAffectingSpell );
curSpell:setRequiredClass( Enums.Ranger );
