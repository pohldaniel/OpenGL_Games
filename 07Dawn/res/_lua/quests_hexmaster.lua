...
function quest_hexmaster.init()
	...
	quest_hexmaster.ornadSaidorInteraction:setInteractionType( Enums.Quest );
	quest_hexmaster.ornadSaidorInteraction:setInteractionCode( "quest_hexmaster.onOrnadSaidorInteraction()" );

	quest_hexmaster.noviceLeader = DawnInterface.addMobSpawnPoint("Wizard", "Novice Leader", 0, 2100, 1, 0, Enums.FRIENDLY);
