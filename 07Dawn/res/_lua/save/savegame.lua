...
thePlayer:setPosition( 486, 640 );
thePlayer:setCurrentHealth(213);
thePlayer:setCurrentMana(116);
...
SpawnPoints.quest_playHideAndSeek.monsterSpawnPoint:setWanderRadius(50);
...
DawnInterface.restoreItemInBackpack( itemDatabase["patchofwolfskin"], 8, 3, 1 );
...
-- equipped Items
DawnInterface.restoreWieldItem( 3, itemDatabase["gnollshield"] );
...
DawnInterface.enterZone( "res/_lua/zone1", 486, 640 );
DawnInterface.setSavingAllowed( true );
