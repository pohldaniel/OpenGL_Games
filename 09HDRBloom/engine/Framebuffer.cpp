...
void Framebuffer::attachTexture(AttachmentTex::AttachmentTex attachments) {
	...
	if (attachments == AttachmentTex::RGBA || attachments == AttachmentTex::RGBA32F || attachments == AttachmentTex::RGBA16F || attachments == AttachmentTex::RGB32F || attachments == AttachmentTex::RGB16F || attachments == AttachmentTex::RED) {
