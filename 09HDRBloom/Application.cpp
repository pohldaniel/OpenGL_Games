...
void Application::loadAssets() {
	...
	Globals::shaderManager.loadShader("bloom", "res/shader/compute/6.bloom.vs", "res/shader/compute/6.bloom.fs");
	Globals::shaderManager.loadShader("bloom_light", "res/shader/compute/6.bloom.vs", "res/shader/compute/6.light_box.fs");
	Globals::shaderManager.loadShader("bloom_blur", "res/shader/compute/6.old_blur.vs", "res/shader/compute/6.old_blur.fs");
	Globals::shaderManager.loadShader("bloom_final", "res/shader/compute/6.bloom_final.vs", "res/shader/compute/6.bloom_final.fs");

	Globals::textureManager.loadTexture("wood", "res/textures/wood.png", true, GL_SRGB, GL_RGB);
	Globals::textureManager.loadTexture("container", "res/textures/container2.png", true, GL_SRGB_ALPHA, GL_RGBA);
	Globals::textureManager.get("wood").setLinear();
	Globals::textureManager.get("wood").setRepeat();
	Globals::textureManager.get("container").setLinear();
	Globals::textureManager.get("container").setRepeat();
