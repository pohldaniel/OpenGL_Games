...
public:
	...
	void buildDiamondXY(const Vector3f& position = Vector3f(-1.0f, -1.0f, 0.0f), const Vector2f& size = Vector2f(2.0f, 2.0f), int uResolution = 1, int vResolution = 1, bool generateTexels = true, bool generateNormals = true, bool generateTangents = false);
	...
	void buildDiskXY(float radius = 1.0f, const Vector3f& position = Vector3f(-1.0f, 0.0f, -1.0f), int vResolution = 1, bool generateTexels = true, bool generateNormals = true, bool generateTangents = false);
	void buildDiskXZ(float radius = 1.0f, const Vector3f& position = Vector3f(-1.0f, 0.0f, -1.0f), int vResolution = 1, bool generateTexels = true, bool generateNormals = true, bool generateTangents = false);
