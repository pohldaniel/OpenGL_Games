...
#define SPRITE_FRGAMENT_ARRAY    "#version 410 core                                                                              \n \
														                                                                         \n \
                                  flat in int layer;		                                                                     \n \
                                  in vec2 texCoord;                                                                              \n \
                                  in vec4 vertColor;                                                                             \n \
...
#define SPRITE_FRGAMENT_TEXTURE    "#version 410 core                                                                              \n \
														                                                                           \n \
                                    flat in int layer;		                                                                       \n \
                                    in vec2 texCoord;                                                                              \n \
                                    in vec4 vertColor;                                                                             \n \
                                    ...
                                    void main() {                                                                                  \n \
                                        vec2 coord = vec2(u_texelTrans.x + u_texelTrans.z * fract(texCoord.x * u_tileFactor.x),    \n \
                                                          u_texelTrans.y + u_texelTrans.w * fract(texCoord.y * u_tileFactor.y));   \n \
                                        outColor = vertColor * texture2D(u_texture, coord);                                        \n \
                                    }"
...
private:
	...
	static std::shared_ptr<Shader> SpriteShaderArray;
	static std::shared_ptr<Shader> SpriteShaderTexture;
