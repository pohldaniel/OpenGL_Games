...
Sprite::Sprite(std::string name, std::string imageName, Shader2* shader)
{
	_objectCount++;
...
Sprite::Sprite(std::string name, Texture2* texture, Shader2* shader)
{
	_objectCount++;
...
Sprite::Sprite(std::string name, Texture2* texture, Shader2* shader, glm::vec2 location, glm::vec2 size)
{
	_objectCount++;
...
void Sprite::SetShader(Shader2* shader)
{
	_shader = shader;
}

void Sprite::SetTexture(Texture2* texture)
{
	_texture = texture;
}

Shader2* Sprite::GetSHader()
{
	return _shader;
}

Texture2* Sprite::GetTexture()
{
	return _texture;
}
