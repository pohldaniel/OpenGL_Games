#include <GL/glew.h>
#include "RenderManagerGL3.h"
#include "MemoryManager.h"
#include "VertexTypes.h"
#include "VertexBufferObjectGL3.h"
#include "VertexArrayObjectGL3.h"
#include "FrameBufferObjectGL3.h"
...
void RenderManagerGL3::CreateTexture(Texture2* image) {
	if (image != 0){
		...
		//remove image data
		MemoryManager::Instance()->FreeTexture(image);
	}
}

void RenderManagerGL3::CreateEmptyTexture(Texture2* image) {
	if (image != 0){
		glGenTextures(1, image->GetIdPointer());
...
void RenderManagerGL3::DestroyTexture(Texture2* image)
{
	if (image != 0)
	{
...
Shader2* RenderManagerGL3::CreateShader()
{
