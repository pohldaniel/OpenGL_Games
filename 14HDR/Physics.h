...
public:
	...
	static btCollisionShape* CreateStaticCollisionShape(AssimpMesh* mesh, const btVector3& scale = btVector3(1, 1, 1));
	static std::vector<btCollisionShape*> CreateStaticCollisionShapes(ObjModel* model, const btVector3 & scale);
	static std::vector<btCollisionShape*> CreateStaticCollisionShapes(AssimpModel* model, const btVector3 & scale);
	static std::vector<btCollisionShape*> CreateStaticCollisionShapes(ObjModel* model, float scale = 1.f);
	static std::vector<btCollisionShape*> CreateStaticCollisionShapes(AssimpModel* model, float scale = 1.f);
