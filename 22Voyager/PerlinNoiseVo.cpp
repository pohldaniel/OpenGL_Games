...
// -------------------
void PerlinNoiseVo::SetSeed(int seed)
{
...
// -------------------
double PerlinNoiseVo::noise(double x, double y, double z)
{
	double result = 0.0;
...
// -------------------
double PerlinNoiseVo::Octave(double x, double y, int octaves)
{
	double result = 0.0;
...
// -------------------
double PerlinNoiseVo::Grad(int hash, double x, double y, double z)
{
	switch (hash & 0xF)
	{
	case 0x0: return  x + y;
