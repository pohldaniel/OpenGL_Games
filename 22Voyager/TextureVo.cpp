...
// -------------------
void TextureVo::GenerateTexture(char* textureId)
{
...
// -------------------
void TextureVo::GenerateMultipleTextures(std::vector<char*>& textureIds)
{
...
// -------------------
void TextureVo::GenerateSkybox(unsigned short int beginIndex, unsigned short int finalIndex)
{
	glGenTextures(1, &m_texture);
	glActiveTexture(GL_TEXTURE0);
...
// -------------------
void TextureVo::ActivateTexture(unsigned int unit)
{
...
// -------------------
void TextureVo::ActivateTextures(unsigned int unit)
{
	assert(unit >= 0 && unit <= 31);
