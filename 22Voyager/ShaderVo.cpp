...
void ShaderVo::SetBool(GLchar* name, bool value) const
{
	glUniform1i(glGetUniformLocation(m_program, name), value);
}

void ShaderVo::SetInt(GLchar* name, int value) const
{
	glUniform1i(glGetUniformLocation(m_program, name), value);
}

void ShaderVo::SetFloat(const char* name, float value) const
{
	glUniform1f(glGetUniformLocation(m_program, name), value);
}

void ShaderVo::SetVec2(const char* name, glm::vec2 value) const
{
	glUniform2f(glGetUniformLocation(m_program, name), value.x, value.y);
}

void ShaderVo::SetVec3(const char* name, glm::vec3 value) const
{
	glUniform3f(glGetUniformLocation(m_program, name), value.x, value.y, value.z);
}

void ShaderVo::SetVec4(GLchar* name, glm::vec4 value) const
{
	glUniform4f(glGetUniformLocation(m_program, name), value.x, value.y, value.z, value.w);
}

void ShaderVo::SetMat4(GLchar* name, glm::mat4 value) const
{
...
// -------------------
GLuint ShaderVo::CreateProgram(char* vertexShaderFile, char* fragmentShaderFile)
{
...
GLuint ShaderVo::CreateProgram(char* vertexShader, char* geomShader, char* fragmentShader)
{
	int LinkingResult = 0;
...
// -------------------
std::string ShaderVo::LoadShaderFromFile(char* shaderFile)
{
...
// -------------------
GLuint ShaderVo::CreateShader(GLenum shaderType, std::string source)
{
