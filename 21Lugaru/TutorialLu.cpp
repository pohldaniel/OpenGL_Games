...
bool TutorialLu::active = false;
int TutorialLu::stage = 0;
float TutorialLu::stagetime = 0;
float TutorialLu::maxtime = 0;
float TutorialLu::success = 0;

void TutorialLu::Do(float multiplier)
{
    ...
    if (stagetime < maxtime - 3) {
        switch (stage) {
            case 3:
                if (GameLu::deltah || GameLu::deltav) {
                    success += multiplier;
                }
                break;
            case 4:
            ...
            case 25:
                ...
                break;
            case 28:
                if (AnimationLu::animations[Person::players[0]->animTarget].attack == reversed && Person::players[0]->feint) {
                    success = 1;
                }
                break;
            case 29:
            ...
            case 45:
            case 46:
                if (AnimationLu::animations[Person::players[0]->animTarget].attack == reversal) {
                    success = 1;
                }
                break;
            case 35:
...
void TutorialLu::DrawTextInfo()
{
    ...
    switch (stage) {
        ...
        case 3:
            ...
            break;
        case 4:
            string = std::string("Try using the W");
            string += std::string(", A");
            string += std::string(", S");
            string += std::string(" and D keys to move around.");
            string2 = "All movement is relative to the camera.";
            break;
        case 5:
            string = std::string("Please press alt to jump.");
            string2 = "You can hold it longer to jump higher.";
            break;
        case 6:
            string = std::string("You can press shift to crouch.");
            string2 = "You can jump higher from a crouching position.";
            break;
        case 7:
            string = std::string("While running, you can press shift to roll.");
            break;
        case 8:
        ...
        case 10:
            ...
            break;
        case 11:
            string = std::string("When you jump at a wall, you can hold alt again");
        ...
        case 14:
            ...
            break;
        case 15:
            string = std::string("Press left Mouse to attack when you are near an enemy.");
        ...
        case 20:
            ...
            string2 = std::string("Run at the enemy while holding left mouse, and press");
            string3 = std::string("the jump key (alt) to attack.");
            break;
        case 21:
        ...
        case 24:
            ...
            string2 = std::string("and pressing jump (alt) or attack (left mouse).");
        ...
        case 28:
            ...
            string3 = std::string("crouch (shift) after attacking to escape from reversals.");
            break;
        case 29:
        ...
        case 30:
            ...
            break;
        case 31:
            string = std::string("To reverse an attack, you must tap crouch (shift) during the");
        ...
        case 40:
            ...
            string2 = std::string("while pressing Q to pick it up.");
            string3 = "You can crouch and press the same key to drop it again.";
            break;
        case 41:
            string = std::string("You can equip and unequip weapons using the E key.");
        ...
        case 48:
            ...
            break;
        case 49:
            string = std::string("When facing an enemy, you can throw the knife with Q.");
	...
	GameLu::text->glPrintOutlined(1, 1, 1, opacity, screenwidth / 2 - 7.6 * string.size() * screenwidth / 1024, screenheight / 16 + screenheight * 4 / 5, string, 1, 1.5 * screenwidth / 1024, screenwidth, screenheight);
	GameLu::text->glPrintOutlined(1, 1, 1, opacity, screenwidth / 2 - 7.6 * string2.size() * screenwidth / 1024, screenheight / 16 + screenheight * 4 / 5 - 20 * screenwidth / 1024, string2, 1, 1.5 * screenwidth / 1024, screenwidth, screenheight);
	GameLu::text->glPrintOutlined(1, 1, 1, opacity, screenwidth / 2 - 7.6 * string3.size() * screenwidth / 1024, screenheight / 16 + screenheight * 4 / 5 - 40 * screenwidth / 1024, string3, 1, 1.5 * screenwidth / 1024, screenwidth, screenheight);

    string = "Press 'tab' to skip to the next item.";
    string2 = "Press escape at any time to";
    string3 = "pause or exit the tutorial.";

	GameLu::text->glPrintOutlined(0.5, 0.5, 0.5, 1, screenwidth / 2 - 7.6 * string.size() * screenwidth / 1024 * .8, 0 + screenheight * 1 / 10, string, 1, 1.5 * screenwidth / 1024 * .8, screenwidth, screenheight);
	GameLu::text->glPrintOutlined(0.5, 0.5, 0.5, 1, screenwidth / 2 - 7.6 * string2.size() * screenwidth / 1024 * .8, 0 + screenheight * 1 / 10 - 20 * .8 * screenwidth / 1024, string2, 1, 1.5 * screenwidth / 1024 * .8, screenwidth, screenheight);
	GameLu::text->glPrintOutlined(0.5, 0.5, 0.5, 1, screenwidth / 2 - 7.6 * string3.size() * screenwidth / 1024 * .8, 0 + screenheight * 1 / 10 - 40 * .8 * screenwidth / 1024, string3, 1, 1.5 * screenwidth / 1024 * .8, screenwidth, screenheight);
}

void TutorialLu::DoStuff(float multiplier)
{
    XYZ temp;
    XYZ temp2;
    XYZ temp3;
