...
public:
	...
	ModelLu model[7];
	ModelLu modellow;
	ModelLu modelclothes;
    int num_models;

	ModelLu drawmodel;
	ModelLu drawmodellow;
	ModelLu drawmodelclothes;
...
private:
    ...
    inline JointLu& joint(int bodypart) { return joints[jointlabels[bodypart]]; }
