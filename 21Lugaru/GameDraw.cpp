...
void GameLu::flash(float amount, int delay) // shouldn't be that way, these should be attributes and Person class should not change rendering.
{
    flashr = 1;
    flashg = 0;
    flashb = 0;
...
/*********************> DrawGLScene() <*****/
int GameLu::DrawGLScene(StereoSide side)
{
