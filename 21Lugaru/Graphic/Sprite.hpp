...
public:
    ...
    static TextureLu cloudtexture;
    static TextureLu bloodtexture;
    static TextureLu flametexture;
    static TextureLu smoketexture;

    static TextureLu cloudimpacttexture;
    static TextureLu snowflaketexture;
    static TextureLu shinetexture;
    static TextureLu bloodflametexture;

    static TextureLu splintertexture;

    static TextureLu leaftexture;
    static TextureLu toothtexture;
