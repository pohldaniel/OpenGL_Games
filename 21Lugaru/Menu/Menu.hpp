...
public:
    ...
    static void addImage(int id, TextureLu texture, int x, int y, int w, int h, float r = 1, float g = 1, float b = 1);
    static void addButtonImage(int id, TextureLu texture, int x, int y, int w, int h, float r = 1, float g = 1, float b = 1);
    static void addMapLine(int x, int y, int w, int h, float startsize, float endsize, float r, float g, float b);
    static void addMapMarker(int id, TextureLu texture, int x, int y, int w, int h, float r, float g, float b);
