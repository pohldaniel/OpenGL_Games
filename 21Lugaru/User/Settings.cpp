...
void DefaultSettings()
{
    ...
    crouchkey = Keyboard::KEY_LSHIFT;
    jumpkey = Keyboard::KEY_LALT;
    leftkey = Keyboard::KEY_A;
    forwardkey = Keyboard::KEY_W;
    backkey = Keyboard::KEY_S;
    rightkey = Keyboard::KEY_D;
    drawkey = Keyboard::KEY_E;
    throwkey = Keyboard::KEY_Q;
    attackkey = Mouse::BUTTON_LEFT;
    consolekey = Keyboard::KEY_GRAVE;
    newdetail = detail;
}
