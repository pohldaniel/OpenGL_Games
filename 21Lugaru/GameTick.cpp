...
void GameLu::playdialoguescenesound()
{
    XYZ temppos;
...
void GameLu::cmd_dispatch(const string cmd)
{
...
bool GameLu::LoadLevel(const std::string& name, bool tutorial)
{
    ...
    for (unsigned i = 0; i < Person::players.size(); i++) {
        ...
        if (i == 0) {
            ...
            Person::players[i]->tempanimation = AnimationLu("Tempanim", lowheight, neutral);
...
bool GameLu::LoadJsonLevel(const std::string& name, bool tutorial)
{
...
void GameLu::ProcessInput() {
    ...
    if (!campaign && !mainmenu) {
        if ((Input::isKeyPressed(static_cast<Keyboard::Key>(jumpkey)) || Input::isKeyPressed(Keyboard::KEY_SPACE))) {
            if (winfreeze) {
                winfreeze = 0;
            }
        }

        if ((Input::isKeyDown(Keyboard::KEY_ESCAPE)) && gameon) {
            if (console) {
                console = false;
                freeze = 0;
            } else if (winfreeze) {
    ...
    if (Input::isKeyPressed(Keyboard::KEY_F6)) {
    ...
    if (Input::isKeyDown(Keyboard::KEY_F7)) {
        if (Input::isKeyDown(Keyboard::KEY_LSHIFT)) {
    ...
    if (Input::isKeyDown(Keyboard::KEY_F8)) {
        if (Input::isKeyDown(Keyboard::KEY_LSHIFT)) {
            stereoseparation += 0.001;
        } else {
            stereoseparation += 0.010;
    ...
    if (devtools && !mainmenu) {
        /* Console */
        if (Input::isKeyPressed(static_cast<Keyboard::Key>(consolekey))) {
            console = !console;
            if (console) {
                OPENAL_SetFrequency(OPENAL_ALL);
            } else {
...
void GameLu::ProcessDevInput()
{
    if (!devtools || mainmenu || console) {
        return;
    }

    if (Input::isKeyDown(Keyboard::KEY_LALT)) {
        /* Enable editor */
        if (Input::isKeyPressed(Keyboard::KEY_M) && !Input::isKeyDown(Keyboard::KEY_LSHIFT)) {
        ...
        if (Input::isKeyPressed(Keyboard::KEY_H)) {
        ...
        /* Freeze */
        if (Input::isKeyPressed(Keyboard::KEY_V)) {
            freeze = !freeze;
            if (freeze) {
                OPENAL_SetFrequency(OPENAL_ALL);
            }
        ...
        /* Ragdoll */
        if (Input::isKeyPressed(Keyboard::KEY_N)) {
        ...
        if (Input::isKeyPressed(Keyboard::KEY_X)) {
            int closest = 0;
            if (!Input::isKeyDown(Keyboard::KEY_LCTRL)) {
        ...
        /* Change skin */
        if (Input::isKeyPressed(Keyboard::KEY_T) && !Input::isKeyDown(Keyboard::KEY_LSHIFT)) {
            int closest = 0;
            if (!Input::isKeyDown(Keyboard::KEY_LCTRL)) {
                closest = findClosestPlayer();
            }
        ...
        if (Input::isKeyPressed(Keyboard::KEY_I) && !Input::isKeyDown(Keyboard::KEY_LSHIFT)) {
            ...
            if (closest > 0 && distsq(&Person::players[closest]->coords, &Person::players[0]->coords) < 144) {
				...
				JointLu& headjoint = Person::players[closest]->joint(head);
    ...
    if (whichlevel != -2 && Input::isKeyPressed(Keyboard::KEY_K) && Input::isKeyDown(Keyboard::KEY_LSHIFT) && !editorenabled) {
        targetlevel++;
    ...
    if (editorenabled) {
        ...
        if (Input::isKeyPressed(Keyboard::KEY_DELETE) && Input::isKeyDown(Keyboard::KEY_LSHIFT)) {
            int closest = findClosestPlayer();
            if (closest > 0) {
        ...
        /* Add player */
        if (Input::isKeyPressed(Keyboard::KEY_P) && !Input::isKeyDown(Keyboard::KEY_LSHIFT) && !Input::isKeyDown(Keyboard::KEY_LCTRL)) {
        ...
        /* Connect waypoint */
        if (Input::isKeyPressed(Keyboard::KEY_P) && Input::isKeyDown(Keyboard::KEY_LCTRL) && !Input::isKeyDown(Keyboard::KEY_LSHIFT)) {
            if (numpathpoints < 30) {
        ...
        if (Input::isKeyPressed(Keyboard::KEY_COMMA) && !Input::isKeyDown(Keyboard::KEY_LSHIFT)) {
            pathpointselected--;
        ...
        if (Input::isKeyPressed(Keyboard::KEY_LEFT) && Input::isKeyDown(Keyboard::KEY_LSHIFT) && !Input::isKeyDown(Keyboard::KEY_LCTRL)) {
            editortype--;
        ...
        if (Input::isKeyPressed(Keyboard::KEY_RIGHT) && Input::isKeyDown(Keyboard::KEY_LSHIFT) && !Input::isKeyDown(Keyboard::KEY_LCTRL)) {
            editortype++;
            if (editortype == treeleavestype || editortype == 10) {
                editortype++;
            }
        ...
        if (Input::isKeyDown(Keyboard::KEY_DOWN) && !Input::isKeyDown(Keyboard::KEY_LCTRL)) {
        ...
        if (Input::isKeyDown(Keyboard::KEY_UP) && !Input::isKeyDown(Keyboard::KEY_LCTRL)) {
            editorsize += multiplier;
        }

        /* Decrease yaw for next object */
        if (Input::isKeyDown(Keyboard::KEY_LEFT) && !Input::isKeyDown(Keyboard::KEY_LSHIFT) && !Input::isKeyDown(Keyboard::KEY_LCTRL)) {
        ...
        if (Input::isKeyDown(Keyboard::KEY_RIGHT) && !Input::isKeyDown(Keyboard::KEY_LSHIFT) && !Input::isKeyDown(Keyboard::KEY_LCTRL)) {
            editoryaw += multiplier * 100;
        }
            ...
            if (Person::players[k]->skeleton.free == 0 &&
                ...
                if (distsq(&Person::players[i]->coords, &Person::players[k]->coords) < 10 * sq((Person::players[i]->scale + Person::players[k]->scale) * 2.5) &&
                    ...
                    if (Person::players[i]->animTarget == jumpupanim &&
						...
						AnimationLu::animations[Person::players[k]->animTarget].height == middleheight &&
                    ...
                    if (Person::players[k]->animTarget == jumpupanim &&
						...
						AnimationLu::animations[Person::players[i]->animTarget].height == middleheight &&
...
void doAerialAcrobatics()
{
    ...
    for (unsigned k = 0; k < Person::players.size(); k++) {
        ...
        if (Person::players[k]->isStop() ||
            ...
            (AnimationLu::animations[Person::players[k]->animTarget].attack &&
...
void doAttacks()
{
    ...
    if (!Input::isMouseDown(static_cast<Mouse::MouseButton>(attackkey))) {
        oldattackkey = 0;
    }
    if (oldattackkey) {
    ...
    if (!oldattackkey) {
        playerrealattackkeydown = Input::isMouseDown(static_cast<Mouse::MouseButton>(attackkey));
    }
    if ((Person::players[0]->parriedrecently <= 0 ||
        ...
        Person::players[0]->attackkeydown = Input::isMouseDown(static_cast<Mouse::MouseButton>(attackkey));
    }
    if (Input::isMouseDown(static_cast<Mouse::MouseButton>(attackkey)) &&
        !oldattackkey &&
    ...
    for (unsigned k = 0; k < Person::players.size(); k++) {
        ...
        if (Person::players[k]->animTarget != rabbitrunninganim && Person::players[k]->animTarget != wolfrunninganim) {
            ...
            if (Person::players[k]->attackkeydown) {
                ...
                //attack
                if (!AnimationLu::animations[Person::players[k]->animTarget].attack &&
                    ...
                    if (Person::players.size() > 1) {
                        for (unsigned i = 0; i < Person::players.size(); i++) {
                            ...
                            if (!Person::players[k]->hasvictim) {
                                if (AnimationLu::animations[Person::players[k]->animTarget].attack != reversal) {
                                    //choose an attack
                                        ...
                                        if (Person::players[k]->isPlayerControlled()) { //human player
                                            ...
                                            if (distance < 2.5 * sq(Person::players[k]->scale * 5) &&
                                                ...
                                                //lowkick
                                                       ...
                                                       AnimationLu::animations[Person::players[i]->animTarget].height == lowheight &&
                                                       AnimationLu::animations[Person::players[k]->animTarget].attack != normalattack) {
                                            ...
                                            if (distance < 4.5 * sq(Person::players[k]->scale * 5)) {
                                                ...
                                                if (!attackweapon && distance < 2.5 * sq(Person::players[k]->scale * 5)) {
                                                    //sweep
                                                    if (randattack == 0 && AnimationLu::animations[Person::players[i]->animTarget].height != lowheight) {
                                                        Person::players[k]->animTarget = sweepanim;
                                                        //upunch
                                                    } else if (randattack == 1 && AnimationLu::animations[Person::players[i]->animTarget].height != lowheight &&
                                                               !attackweapon) {
                                                        Person::players[k]->animTarget = upunchanim;
                                                        //spinkick
                                                    } else if (randattack == 2 && AnimationLu::animations[Person::players[i]->animTarget].height != lowheight) {
                                                        Person::players[k]->animTarget = spinkickanim;
                                                        //lowkick
                                                    } else if (AnimationLu::animations[Person::players[i]->animTarget].height == lowheight) {
                                                        Person::players[k]->animTarget = lowkickanim;
                                                    }
                                                }
                                                if (attackweapon) {
                                    ...
                                    if (AnimationLu::animations[Person::players[k]->animTarget].attack == normalattack &&
                                        Person::players[k]->victim == Person::players[i] &&
                                        (!Person::players[i]->skeleton.free)) {
                                        oldattackkey = 1;
                                        Person::players[k]->frameTarget = 0;
                    ...
                    if (k == 0 && Person::players.size() > 1) {
                        for (unsigned i = 0; i < Person::players.size(); i++) {
                            ...
                            if ((playerrealattackkeydown || Person::players[i]->dead || !hasstaff) &&
								AnimationLu::animations[Person::players[k]->animTarget].attack == neutral) {
                                const float distance = distsq(&Person::players[k]->coords, &Person::players[i]->coords);
                    ...
                    if (Person::players[k]->isPlayerControlled()) {
                        ...
                        if (Person::players[k]->attackkeydown &&
                            ...
                            ((Person::players[k]->hasvictim &&
                              ...
                              AnimationLu::animations[Person::players[k]->victim->animTarget].height != lowheight &&
                    ...
                    //update counts
                    if (AnimationLu::animations[Person::players[k]->animTarget].attack && k == 0) {
                        numattacks++;
                        switch (attackweapon) {
                            case 0:
                                numunarmedattack++;
    ...
    if (Person::players.size() > 1) {
        for (unsigned k = 0; k < Person::players.size(); k++) {
            for (unsigned i = k + 1; i < Person::players.size(); i++) {
                ...
                if ((AnimationLu::animations[Person::players[i]->animTarget].attack != reversed &&
					AnimationLu::animations[Person::players[i]->animTarget].attack != reversal &&
					AnimationLu::animations[Person::players[k]->animTarget].attack != reversed &&
					AnimationLu::animations[Person::players[k]->animTarget].attack != reversal) ||
                    (i != 0 && k != 0)) {
                    if ((AnimationLu::animations[Person::players[i]->animCurrent].attack != reversed &&
						AnimationLu::animations[Person::players[i]->animCurrent].attack != reversal &&
						AnimationLu::animations[Person::players[k]->animCurrent].attack != reversed &&
						AnimationLu::animations[Person::players[k]->animCurrent].attack != reversal) ||
                        (i != 0 && k != 0)) {
                        //neither is sleeping
                                                                ...
                                                                if ((Person::players[i]->skeleton.oldfree == 1 && findLengthfast(&Person::players[i]->velocity) > 1) ||
                                                                    ...
                                                                    if ((Person::players[i]->animTarget != getupfrombackanim && Person::players[i]->animTarget != getupfromfrontanim ||
                                                                        ...
                                                                        if ((((k != 0 && findLengthfast(&rotatetarget) > 150 ||
                                                                             ...
                                                                             (k == 0 ||
                                                                              k != 0 && Person::players[i]->skeleton.oldfree == 1 && AnimationLu::animations[Person::players[k]->animCurrent].attack == neutral ||
                                                                              /*i!=0&&*/ Person::players[k]->skeleton.oldfree == 1 && AnimationLu::animations[Person::players[i]->animCurrent].attack == neutral)) ||
                                                                    ...
                                                                    if ((AnimationLu::animations[Person::players[i]->animTarget].attack == neutral ||
																		AnimationLu::animations[Person::players[i]->animTarget].attack == normalattack) &&
                                                                        (AnimationLu::animations[Person::players[k]->animTarget].attack == neutral ||
																			AnimationLu::animations[Person::players[k]->animTarget].attack == normalattack)) {
                                                                        //If bumped
    ...
    */
    ...
    if (!mainmenu) {
        ...
        if (!freeze && !winfreeze && !(mainmenu && gameon) && (gameon || !gamestarted)) {
            ...
            if (talkdelay <= 0 && !Dialog::inDialog() && AnimationLu::animations[Person::players[0]->animTarget].height != highheight) {
            ...
            //control keys
            if (!Dialog::inDialog()) {
                Person::players[0]->forwardkeydown = Input::isKeyDown(static_cast<Keyboard::Key>(forwardkey));
                Person::players[0]->leftkeydown = Input::isKeyDown(static_cast<Keyboard::Key>(leftkey));
                Person::players[0]->backkeydown = Input::isKeyDown(static_cast<Keyboard::Key>(backkey));
                Person::players[0]->rightkeydown = Input::isKeyDown(static_cast<Keyboard::Key>(rightkey));
                Person::players[0]->jumpkeydown = Input::isKeyDown(static_cast<Keyboard::Key>(jumpkey));
                Person::players[0]->crouchkeydown = Input::isKeyDown(static_cast<Keyboard::Key>(crouchkey));
                Person::players[0]->drawkeydown = Input::isKeyDown(static_cast<Keyboard::Key>(drawkey));
                Person::players[0]->throwkeydown = Input::isKeyDown(static_cast<Keyboard::Key>(throwkey));
            } else {
            ...
            if (!editorenabled &&
                (whichlevel != -2 &&
                     (Input::isKeyDown(Keyboard::KEY_K) &&
                      Input::isKeyDown(Keyboard::KEY_LALT) &&
                      devtools) ||
                 (Input::isKeyDown(static_cast<Keyboard::Key>(jumpkey)) &&
                  !respawnkeydown &&
                  !oldattackkey &&
            ...
            respawnkeydown = Input::isKeyDown(static_cast<Keyboard::Key>(jumpkey));
            ...
            for (unsigned i = 0; i < Person::players.size(); i++) {
                ...
                if (!Person::players[i]->skeleton.free) {
                    ...
                    if (i == 0 && !Dialog::inDialog()) {
                        ...
                        if (!AnimationLu::animations[Person::players[0]->animTarget].attack &&
                    ...
                    if (i != 0 && Person::players[i]->isPlayerControlled() && !Dialog::inDialog()) {
                        if (!AnimationLu::animations[Person::players[i]->animTarget].attack &&
                            Person::players[i]->animTarget != staggerbackhighanim &&
                    ...
                    if (i != 0 && Person::players[i]->surprised <= 0 &&
                        ...
                        !Person::players[i]->dead &&
                        !Person::players[i]->skeleton.free &&
						AnimationLu::animations[Person::players[i]->animTarget].attack == neutral) {
                        numresponded = 1;
                    }
...
void GameLu::TickOnceAfter()
{
    ...
    if (!cameramode) {
        if ((AnimationLu::animations[Person::players[0]->animTarget].attack != 3 && AnimationLu::animations[Person::players[0]->animCurrent].attack != 3) || Person::players[0]->skeleton.free) {
