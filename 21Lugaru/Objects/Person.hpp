...
public:
    ...
    inline JointLu& joint(int bodypart) { return skeleton.joints[skeleton.jointlabels[bodypart]]; }
    ...
    inline AnimationFrame& currentFrame() { return AnimationLu::animations.at(animCurrent).frames.at(frameCurrent); }
    inline AnimationFrame& targetFrame() { return AnimationLu::animations.at(animTarget).frames.at(frameTarget); }
