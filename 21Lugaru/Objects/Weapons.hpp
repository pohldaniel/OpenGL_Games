...
private:
    static ModelLu throwingknifemodel;
    static TextureLu knifetextureptr;
    static TextureLu lightbloodknifetextureptr;
    static TextureLu bloodknifetextureptr;

    static ModelLu swordmodel;
    static TextureLu swordtextureptr;
    static TextureLu lightbloodswordtextureptr;
    static TextureLu bloodswordtextureptr;

    static ModelLu staffmodel;
    static TextureLu stafftextureptr;
